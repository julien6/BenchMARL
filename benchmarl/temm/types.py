...
class TEMMDiagnostics:
    ...
    trajectory_timelines: Dict[str, List[Dict[str, Any]]] = field(default_factory=dict)
    role_members: Dict[str, List[str]] = field(default_factory=dict)
    role_prototypes: Dict[str, Dict[str, Any]] = field(default_factory=dict)
    goal_prototypes: Dict[str, Dict[str, Any]] = field(default_factory=dict)
    role_distance_matrix: List[List[float]] = field(default_factory=list)
    role_distance_labels: List[str] = field(default_factory=list)
    goal_distance_matrix: List[List[float]] = field(default_factory=list)
